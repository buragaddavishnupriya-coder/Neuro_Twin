...
def run_all_evaluations():
    ...
    print("\n[1/4] Training Parkinson's Disease Models...")
    ...
    print("\n[2/4] Training Alzheimer's Disease Models...")
    ...
    # 3. GENERATING PUBLICATION PLOTS (300 DPI)
    print("\n[3/4] Generating 300-DPI Publication-Grade Figures...")
    ...
    # 4. EXPORT JSON AND LATEX TABLE
    print("\n[4/4] Exporting IEEE LaTeX Table and JSON Data...")
